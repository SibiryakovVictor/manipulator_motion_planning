...
bool coll::CollisionDetector::spherePhase( 
...
bool coll::CollisionDetector::areObjectsCollided( const env::OBB & obj1, 
												  const env::OBB & obj2  ) const
{
...
bool coll::CollisionDetector::checkSeparatingPlane(
...
bool coll::CollisionDetector::satPhase( const OBB & obj1, const OBB & obj2 ) const
{
...
Eigen::Vector3f coll::CollisionDetector::cross( const Eigen::Vector3f & v1,

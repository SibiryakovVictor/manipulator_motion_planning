...
env::ManipInitInfo env::load::getManipInitInfo()
{
	...
	ManipInitInfo::LinkInitInfo link7Info(
		...
		Position( -0.013000000268221, 0.1458999812603, 0.82846993932724 ),
		Position( -0.012999993748963, 0.12509997189045, 0.82849980125427 ),
		6,
		2,
		5,
	...
	ManipInitInfo::LinkInitInfo link8Info(
		...
		Position( -0.0031999973580241, 0.18547001481056, 0.8284994436264 ),
		Position( -0.0029000013601035, 0.16499999165535, 0.82849968204498 ),
		7,
		2,
		5,
	...
	ManipInitInfo::LinkInitInfo link9Info(
		...
		Position( -0.048372000455856, 0.14589999616146, 0.8284698797226 ),
		Position( -0.048372000455856, 0.12510001659393, 0.82849986085892 ),
		6,
		2,
		6,
	...
	ManipInitInfo::LinkInitInfo link10Info(
		...
		Position( -0.05816999822855, 0.1854699999094, 0.82846993932724 ),
		Position( -0.05816999822855, 0.16500000655651, 0.82849998006821 ),
		9,
		2,
		6,
		{ -0, 0, -0 },
